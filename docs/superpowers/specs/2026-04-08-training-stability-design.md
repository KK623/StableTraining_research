...
**信源要求**：
- [NVIDIA Transformer Engine文档](https://docs.nvidia.com/deeplearning/transformer-engine/)
- [Google Brain BF16论文](https://arxiv.org/abs/1905.12322)
...
### 3.1 初始化策略
- Xavier/Glorot初始化 [Glorot & Bengio 2010]
- Kaiming/He初始化 [He et al. 2015]
- Fixup初始化 [Zhang et al. 2019]
- 低精度训练中的初始化调整
...
### 3.2 归一化层的数值行为
- BatchNorm的数值稳定性（epsilon选择、batch size影响）
- LayerNorm的FP16问题
- RMSNorm的稳定性优势 [Zhang & Sennrich 2019]
...
**信源**：
- [To FP8 and Back Again: Quantifying the Effects of Reducing Precision on LLM Training Stability](https://arxiv.org/html/2405.18710v1)
...
**信源**：
- [Microscaling Formats for Deep Learning](https://arxiv.org/abs/2310.10537)
- [DeepSeek-V3 Technical Report](https://arxiv.org/html/2412.19437v1#S5)
- [NVIDIA Blackwell Architecture](https://developer.nvidia.com/blog/per-tensor-and-per-block-scaling-strategies-for-effective-fp8-training/)
...
- [A Simple and Efficient Stochastic Rounding Method for Training Neural Networks in Low Precision](https://ar5iv.labs.arxiv.org/html/2103.13445)
...
**信源**：
- [Error Compensated Quantized SGD](https://arxiv.org/abs/1611.05301)
...
**信源**：
- [MOSS: Microscaling Optimized for Storage and Speed](https://arxiv.org/abs/2310.10537)
...
**信源**：
- [u-μP: The Unit-Scaled Maximal Update Parametrization](https://arxiv.org/pdf/2407.17465v2)
...
**信源**：
- [DeepSeek-V3 Technical Report](https://arxiv.org/html/2412.19437v1#S5)
- [NVFP4 Low-Precision Training](https://developer.nvidia.com/blog/using-nvfp4-low-precision-model-training-for-higher-throughput-without-losing-accuracy/)
...
**信源**：
- [L-GRECO: Layerwise-Adaptive Gradient Compression](https://proceedings.mlsys.org/paper_files/paper/2024/file/9069a8976ff06f6443e7f4172990a580-Paper-Conference.pdf)
...
**信源**：
- [Communication Efficient Distributed Training with Distributed Lion](https://arxiv.org/pdf/2404.00438.pdf)
